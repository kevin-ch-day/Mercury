...
def _print_live_mode_guide() -> None:
    ...
    output.write("Use Backup Operations -> Back up and verify production, or: ./run.sh backup full")
    ...
    output.write("Use Backup Operations -> Verify and update backup records, or: ./run.sh backup verify-all")
    output.write("")
    ...
    output.write("")
    output.write("Safety")
    output.write("Sync requires explicit default-no confirmation and readiness checks.")
